...
(describe "make-flight-category-line"
  (it "formats a complete metar correctly"
    (should= {:line "KORD  VFR CLR        10 15   ", :color config/vfr-color}
  ...
  (it "handles nil values correctly"
    (should= {:line "KORD      CLR        10 15G20", :color config/info-color}
  ...
  (it "handles non-CLR cover with cloud base"
    (should= {:line "KORD  IFR BKN   030   5 10G15", :color config/ifr-color}
