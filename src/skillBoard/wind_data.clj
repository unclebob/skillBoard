  ...
  (try
    ...
    (catch Exception e
      (core-utils/log-event :error :communication-issue
                            (str "Error fetching wind data: " (.getMessage e)))
